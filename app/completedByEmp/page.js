...
import { faEye, faSpinner, faFileExcel, faComment, faSquareCaretLeft, faCaretSquareRight } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <>
      ...
      <div className="m-5 pl-5 md:pl-72 mt-20">
        <h1 className="text-xl font-bold mb-4 text-orange-500">Completed Task List</h1>
                      ...
                      <tr key={task._id} className='cursor-pointer hover:bg-gray-100 text-sm'>
                        ...
                        <td className="border px-4 py-1.5 text-center border-green-500 ">
                          <div className="flex items-center mx-5">
                            <FontAwesomeIcon
                              icon={faEye}
                              className="text-blue-500 hover:underline cursor-pointer text-sm mr-5"
                            ...
                            <FontAwesomeIcon
                              icon={faComment}
                              className="text-yellow-600 cursor-pointer text-base text-right ml-1"

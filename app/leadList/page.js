...
import { faPenToSquare, faTrash, faEye, faFileExcel, faXmark } from '@fortawesome/free-solid-svg-icons';
              ...
              {leads.length > 0 ? (
                currentLeads.map((lead, index) => (
                  <tr key={lead._id} className='text-sm'>
                    <td className="border border-gray-200 px-4 py-1 text-center">{calculateSerialNumber(index)}</td>
                    <td className="border border-gray-200 px-4 py-1 text-center">{lead.customerName}</td>
                    <td className="border border-gray-200 px-4 py-1 text-center">{lead.description}</td>
                    <td className="border border-gray-200 px-4 py-1 text-center">{lead.contactNo}</td>
                    <td className="border border-gray-200 px-4 py-1 text-center">{lead.email}</td>
                    <td className="border border-gray-200 px-4 py-1 text-center">
                      <FontAwesomeIcon
                        icon={faEye}

...
import { faCaretSquareLeft, faCaretSquareRight, faComment, faEye } from '@fortawesome/free-solid-svg-icons';
                                    ...
                                    todaysTasks.map((task, index) => (
                                        <tr key={task._id} className='text-sm hover-bg-gray-100 cursor-pointer'>
                                            ...
                                            <td className="border px-4 py-1.5 text-center">
                                                <span className={`rounded-full text-xs font-bold px-5 py-1 ${task.status === 'completed' ? 'text-green-800 bg-green-200' :
                                            ...
                                            <td className="border px-4 py-1.5 text-center">
                                                ...
                                                <FontAwesomeIcon
                                                    icon={faComment}
                                                    className="text-yellow-600 cursor-pointer text-base text-right ml-3"

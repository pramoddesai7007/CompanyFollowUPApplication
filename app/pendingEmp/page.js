  ...
  return (
    <>
      ...
      <div className="m-5 pl-5 md:pl-72 mt-20">
        <h2 className="text-lg md:text-xl font-bold mb-4 text-orange-500">Pending Task List</h2>
        <div>
                  ...
                  currentTasks.map((task, index) => (
                    <tr key={task._id} className='hover:bg-gray-100 text-sm cursor-pointer'>
                      ...
                      <td className="px-6 py-1 whitespace-nowrap border  text-center">
                        <span className='px-4 py-1 bg-blue-200 text-blue-800 rounded-full text-xs font-bold'>Pending</span></td>
                      ...
                      <td className="px-3 py-1 whitespace-nowrap border">
                        <FontAwesomeIcon
                          icon={faEye}
                          className="text-blue-500 hover:underline cursor-pointer text-sm text-center pl-7"
                        ...
                        <FontAwesomeIcon
                          icon={faComment}
                          className="text-yellow-600 cursor-pointer text-base text-right pl-5"
